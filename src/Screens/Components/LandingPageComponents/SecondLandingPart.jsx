  ...
  return (
    <div className="max-w-6xl ml-80" style={{ marginTop: '300px' }}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 gap-y-15">
        ...
        {/* Card 5 - WorkFlow */}
        <div className="bg-white shadow-md p-4 rounded-md flex items-center mt-8">
        ...
        {/* Card 7 - Apps */}
        <div className="bg-white shadow-md p-4 rounded-md flex items-center justify-center mt-8">
