...
export default function Sidebar({ open, navItems = defaultNavItems, setOpen }) {
  const ref = useRef();
  ...
  return (
    ...
    className={classNames({
      ...
      "bg-green-50 text-zinc-50": true, // colors
        ...
        {navItems.map((item, index) => {
          return (
              ...
              <li key={index} href={item.href}
                className={classNames({
                  "text-green-700 hover:bg-green-900": true, //colors
